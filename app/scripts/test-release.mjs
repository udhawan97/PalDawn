...
assert.doesNotMatch(source, /\.(glb|gltf|fbx|obj|blend)(?:[?"'])/i, 'unreviewed anatomy/binary assets are not allowed in v0.5')
assert.doesNotMatch(source, /[\u0900-\u097f]/u, 'the v0.5 application surface must remain English-only')
