# Graph Report - PalDawn  (2026-09-07)

## Corpus Check
- 163 files · ~260,158 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 991 nodes · 1524 edges · 90 communities (82 shown, 8 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dad34b7a`
...
Cohesion: 0.08
Nodes (28): CAPTION_SCALES, emptyWorkspace(), failedStorageKeys, ImportedSettings, JourneySession, LocalDataExportResult, LocalDataImport, LocalDataImportPreview (+20 more)
...
Cohesion: 0.06
Nodes (50): ATLAS_EVIDENCE_STATUS, AtlasEvidenceLedger, AtlasSourceCoverage, buildAtlasEvidenceLedger(), AtlasSearchResult, AtlasSearchResultKind, normalizeSearchText(), scoreMatch() (+42 more)
...
Cohesion: 0.05
Nodes (38): Geometry conventions, Original heart form study, Reproduce, Review and adoption, A single playback frame, Acceptance: what “top notch” must demonstrate, Asset production: the critical path, Evidence: why the current scene cannot meet this target (+30 more)

### Community 26 - "Changelog"
Cohesion: 0.25
Nodes (7): [0.1.0] — 2026-08-20, [0.2.0] — 2026-08-22, [0.3.0] — 2026-08-24, Changelog, First Light, Mechanism Lens, Systems Atlas

### Community 27 - "verify-heart.mjs"
Cohesion: 0.06
Nodes (31): manifest, meshes, output, root, source, spec, directions, fitStudyCamera() (+23 more)
...
Cohesion: 0.10
Nodes (38): clampProgress(), formatDuration(), formatJourneyTime(), JOURNEY, JourneyDefinition, JourneyStage, progressForStageId(), stageAt() (+30 more)
...
### Community 57 - "executeLocalDataTransaction"
Cohesion: 0.15
Nodes (22): encodeGLB(), applyDesiredValues(), bindValueToGeneration(), executeLocalDataTransaction(), LOCAL_DATA_KEY_LIST, LOCAL_DATA_KEYS, LocalDataRecoveryState, newResetToken() (+14 more)

### Community 58 - "VoyageScene.tsx"
Cohesion: 0.15
Nodes (11): routeFrameAt(), RouteSlice, HumanSystemsScene(), ArrivalBeacon(), CORRIDOR_INK, CorridorRings(), DEEP_INK, RuntimeProbe() (+3 more)
...
### Community 73 - "HumanSystemsScene.tsx"
Cohesion: 0.18
Nodes (5): BODY_DETAIL_POINTS, Organ(), OrganProps, PhaseSignal(), resolveTier()
...
### Community 76 - "Medical Guardrails"
Cohesion: 0.22
...
### Community 84 - "Credits and Prior Art"
Cohesion: 0.50
Nodes (4): Clean-Room Influences, Credits and Prior Art, Used Direct Dependencies, Clean-Room Rejection Rule

### Community 86 - "useSettings"
Cohesion: 0.39
Nodes (9): JourneyPlaybackDriver(), CameraDirector(), PortalGate(), VoyageScene(), useExperience, useSettings, ControlDeck(), Intro() (+1 more)

## Knowledge Gaps
- **415 isolated node(s):** `VIEWS`, `totalTriangles`, `MaterialMode`, `root`, `source` (+410 more)
...
- **Why does `exportLocalData()` connect `SettingsPanel` to `executeLocalDataTransaction`, `FlightDeck.tsx`, `localData.ts`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `encodeGLB()` connect `executeLocalDataTransaction` to `verify-heart.mjs`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `activatePwaUpdate()` connect `pwa.ts` to `FlightDeck.tsx`?**
