...
## Corpus Check
- 89 files · ~59,875 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 366 nodes · 529 edges · 22 communities (21 shown, 1 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba0786a1`
...
2. `useSettings` - 17 edges
3. `validateRecord()` - 16 edges
4. `useExperience` - 15 edges
5. `compilerOptions` - 15 edges
6. `PalDawn backlog #3: heart/coronary per-object asset audit dossier` - 11 edges
7. `GitHub Reconnaissance Evidence Dossier` - 11 edges
8. `PalDawn Engineering Scaffold` - 11 edges
9. `smoothRange()` - 10 edges
10. `resolveTier()` - 10 edges
...
Cohesion: 0.05
Nodes (64): Medical Accuracy Report, Bug Report, Journey Proposal, CI Workflow, Pull Request Quality Gate, GitHub Pages Deploy Workflow, Static Pages Deployment, PalDawn HTML Shell (+56 more)
...
### Community 3 - "App.tsx"
Cohesion: 0.13
Nodes (11): App(), SceneBoundary, SceneBoundaryState, rootEl, VoyageScene(), QualityTier, ResolvedTier, resolveTier() (+3 more)
...
Cohesion: 0.07
Nodes (29): author, description, devDependencies, @types/node, @types/react, @types/react-dom, typescript, vite (+21 more)
...
### Community 9 - "FlightDeck.tsx"
Cohesion: 0.06
Nodes (50): clampProgress(), formatJourneyTime(), JOURNEY, JourneyDefinition, JourneyStage, NarrationMode, stageAt(), stageIndexAt() (+42 more)
...
### Community 16 - "Q: How do PalDawn per-object anatomy provenance records enforce fail-closed adoption for this audit?"
Cohesion: 0.40
...
### Community 17 - "Q: How do PalDawn per-object anatomy provenance records enforce fail-closed adoption for this audit?"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: How do PalDawn per-object anatomy provenance records enforce fail-closed adoption for this audit?, Source Nodes
...
Cohesion: 0.29
Nodes (8): Codex-Claude Working Model, Attribution and License Compliance Mission, Codex Reconnaissance Prompt, GitHub Reconnaissance Mission, Prompt Back to Claude, Adversarial Graphics Design Review, Design Review Prompt, Prompt Back to Claude
...
## Knowledge Gaps
- **128 isolated node(s):** `name`, `version`, `description`, `main`, `test` (+123 more)
...
- **Why does `PalDawn Project Plan` connect `PalDawn Project Plan` to `Codex Reconnaissance Prompt`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `package.json`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **What connects `name`, `version`, `description` to the rest of the system?**
  _128 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `PalDawn Project Plan` be split into smaller, more focused modules?**
