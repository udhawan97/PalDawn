# Graph Report - PalDawn  (2026-09-25)

## Corpus Check
- 203 files · ~326,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1222 nodes · 1947 edges · 103 communities (90 shown, 13 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `62158f0c`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- PalDawn Project Plan
- compilerOptions
- localData.ts
- validate.mjs
- dependencies
...
- vite-env.d.ts
- vite.config.ts
- audit_z_anatomy_blend.py
- PalDawn Engineering Scaffold
- DiseaseExplorer.tsx
- test-release.mjs
- PalDawn Overview
...
- test-foundation-runtime.mjs
- tsconfig.graphics.json
- AnatomyStudy.tsx
- prepare-anatomy.mjs
- prepare-anatomy-reading.mjs
- UPSTREAM.md
- workbench.spec.mjs
- AnatomyLanding
- experience.ts
...
2. `useExperience` - 22 edges
3. `FlightDeck()` - 22 edges
4. `scripts` - 18 edges
5. `useAtlas` - 18 edges
6. `SettingsPanel()` - 18 edges
7. `PalDawn Project Plan` - 18 edges
8. `validateRecord()` - 16 edges
9. `DISEASES` - 15 edges
10. `storage()` - 15 edges
...
- `Founder Vision` --semantically_similar_to--> `Evidence-Linked Causal Voyage`  [INFERRED] [semantically similar]
  docs/BRIEF-FOR-CODEX.md → README.md
- `Product Pillars` --semantically_similar_to--> `Journeys, Inside, Atlas, and Research Modes`  [INFERRED] [semantically similar]
...
- **P0 Technical Slice** — app_readme_locked_webgl2_stack, docs_plan_canonical_coronary_route, docs_plan_p0_graphics_directives, docs_plan_performance_proof_protocol, docs_research_github_recon_evidence_shared_route_and_analytic_blood [INFERRED 0.85]
...
Cohesion: 0.06
Nodes (66): AtlasStudyData, AtlasStudyPosition, AtlasStudyRecord, bindValueToGeneration(), CAPTION_SCALES, emptyAtlasStudy(), emptyWorkspace(), executeLocalDataTransaction() (+58 more)

### Community 4 - "validate.mjs"
Cohesion: 0.16
Nodes (16): EXPECTED_INVALID, APPROVAL, CODE_ALLOW, CODE_TYPES, CODE_ZONES, CONTENT_ALLOW, get(), MAPPING_STATUS (+8 more)
...
Cohesion: 0.20
Nodes (13): ALLOW, allowed, classifyExpression(), classifyId(), denied, entries, licenseOf(), NM (+5 more)
...
Cohesion: 0.10
Nodes (23): AUTHOR_POINTS, authoredCurve, frames, NormalizedLookupCurve, ROUTE_LOOKUP, RouteFrame, routeFrameAt(), RouteSlice (+15 more)

### Community 10 - "gen-npm-records.mjs"
Cohesion: 0.22
Nodes (8): APP, CREATORS, direct, lock, pkg, RECORDS, SPDX_URLS, STAMP

### Community 11 - "Curriculum 50 and multiscale engine plan"
Cohesion: 0.06
...
### Community 12 - "pwa.ts"
Cohesion: 0.16
Nodes (24): serviceWorker, rootEl, abandonedUpdateRequests, activatePwaUpdate(), BeforeInstallPromptEvent, beginUpdateHandoff(), blockUpdateHandoffKeyboardInput(), clearActivationWatchdog() (+16 more)
...
### Community 17 - "DiseaseExplorer.tsx"
Cohesion: 0.05
Nodes (62): ATLAS_EVIDENCE_STATUS, AtlasEvidenceLedger, AtlasSourceCoverage, buildAtlasEvidenceLedger(), AtlasSearchResult, AtlasSearchResultKind, normalizeSearchText(), scoreMatch() (+54 more)
...
### Community 24 - "PalDawn living-instrument brand system"
Cohesion: 0.13
Nodes (13): Acceptance checklist, Core palette, Medical and visual authority boundary, PalDawn living-instrument brand system, Source and intent, Surface map, The living mark, Typography and composition (+5 more)

### Community 25 - "PalDawn backlog #3: heart/coronary per-object asset audit dossier"
Cohesion: 0.04
Nodes (43): Geometry conventions, Original heart form study, Reproduce, Review and adoption, A single playback frame, Acceptance: what “top notch” must demonstrate, Asset production: the critical path, Evidence: why the current scene cannot meet this target (+35 more)

### Community 26 - "Changelog"
Cohesion: 0.18
Nodes (10): [0.1.0] — 2026-08-20, [0.2.0] — 2026-08-22, [0.3.0] — 2026-08-24, [0.4.0] — 2026-09-10, Changelog, First Light, Mechanism Lens, Systems Atlas (+2 more)

### Community 27 - "test-pwa-browser-lifecycle.mjs"
Cohesion: 0.18
Nodes (17): APP_ROOT, archiveRevision(), buildInto(), cleanup(), closeServer(), contentTypes, createStaticServer(), delayActivationCacheCleanup() (+9 more)

### Community 28 - "PalDawn Foundation+"
Cohesion: 0.33
...
### Community 31 - "Foundation+3 acceptance evidence"
Cohesion: 0.33
Nodes (5): Automated gates, Browser observation, Foundation+3 acceptance evidence, Known limits, Storage and import boundary

### Community 32 - "Foundation+4: disease systems explorer"
Cohesion: 0.33
...
### Community 42 - "Atlas Wayfinding"
Cohesion: 0.40
Nodes (4): Atlas Wayfinding, Boundary, Feature set, Verification contract

### Community 43 - "PalDawn Foundation+2"
Cohesion: 0.40
Nodes (4): Boundary, PalDawn Foundation+2, Six high-confidence features, Verification contract

### Community 45 - "test-mechanism-lens.mjs"
Cohesion: 0.25
Nodes (6): app, canvas, explorer, playwright, ROOT, scene

### Community 46 - "PalDawn Foundation+3"
Cohesion: 0.40
Nodes (4): Boundary, PalDawn Foundation+3, Six high-confidence features, Verification contract

### Community 47 - "Foundation+ acceptance evidence"
Cohesion: 0.40
Nodes (4): Automated gates, Browser acceptance, Foundation+ acceptance evidence, Known limitations

### Community 50 - "useSettings"
Cohesion: 0.13
Nodes (15): JourneyApp(), JourneyPlaybackDriver(), SceneBoundaryState, SceneCanvas, Organ(), PhaseSignal(), SceneCanvasProps, PortalGate() (+7 more)

### Community 52 - "PalDawn v0.2.0 — Systems Atlas"
Cohesion: 0.40
Nodes (4): Evidence and safety boundary, PalDawn v0.2.0 — Systems Atlas, Verification, What is included

### Community 53 - "useExperience"
Cohesion: 0.24
Nodes (16): progressForStageId(), stageAt(), stageUrl(), copyText(), downloadText(), shareOrCopy(), SharePayload, useExperience (+8 more)

### Community 54 - "PalDawn v0.3.0 — Mechanism Lens"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (25): absent, asset, assetSha256, bytes, creator, generatorSha256, id, license (+17 more)

### Community 56 - "MemoryStorage"
Cohesion: 0.22
Nodes (3): encodeGLB(), MemoryStorage, applyDesiredValues()

### Community 57 - "verify-flow.mjs"
Cohesion: 0.09
Nodes (34): directions, fitStudyCamera(), StudyView, cellFrame(), cellGeometry(), cellSeeds(), createRadiusTable(), FLOW (+26 more)

### Community 58 - "FlightDeck.tsx"
Cohesion: 0.10
Nodes (26): diagnosticReport(), exportLocalData(), exportRawLocalDataRecoveryBackup(), getLocalDataRecoveryState(), LearnerWorkspace, saveLearnerWorkspace(), saveStageBookmarks(), checkForPwaUpdate() (+18 more)

### Community 60 - "Community conduct"
Cohesion: 0.50
Nodes (3): Community conduct, Expected, Not acceptable

### Community 62 - "CurriculumCatalog.tsx"
Cohesion: 0.08
...
### Community 64 - "Security policy"
Cohesion: 0.50
Nodes (3): Report a vulnerability, Security policy, Supported version

### Community 65 - "verify-heart.mjs"
Cohesion: 0.15
Nodes (10): allBounds, heartBounds, manifest, meshes, output, publicFiles, root, source (+2 more)

### Community 69 - "scripts"
Cohesion: 0.11
Nodes (18): scripts, anatomy:build, anatomy:dev, anatomy:prepare, anatomy:preview, anatomy:test, build, dev (+10 more)

### Community 70 - "flow.spec.mjs"
Cohesion: 0.80
Nodes (4): ready(), scene(), seek(), settled()

### Community 73 - "Next phase: Study Continuity"
Cohesion: 0.17
...
### Community 74 - "build-heart.mjs"
Cohesion: 0.25
Nodes (6): manifest, meshes, output, root, source, spec

### Community 75 - "package.json"
Cohesion: 0.20
Nodes (9): author, description, keywords, license, main, name, private, type (+1 more)

### Community 76 - "PalDawn v0.4.0 — Study and Reliability"
Cohesion: 0.40
...
### Community 77 - "test-foundation-runtime.mjs"
Cohesion: 0.40
Nodes (4): APP_ROOT, FailingStorage, installBrowserStubs(), withModules()
...
Cohesion: 0.06
Nodes (52): allConceptIds, base, compressed, context, female, ligament, ligamentContext, male (+44 more)

### Community 80 - "prepare-anatomy.mjs"
Cohesion: 0.20
Nodes (9): atlas, female, femaleText, files, pack, repo, structures, systems (+1 more)

### Community 81 - "prepare-anatomy-reading.mjs"
Cohesion: 0.40
Nodes (4): context, contextPath, directories, pages

### Community 83 - "workbench.spec.mjs"
Cohesion: 1.00
Nodes (3): ready(), settled(), specimen()

### Community 85 - "experience.ts"
Cohesion: 0.17
Nodes (15): clampProgress(), formatDuration(), formatJourneyTime(), JOURNEY, JourneyDefinition, JourneyStage, NarrationMode, stageIdFromHash() (+7 more)

### Community 86 - "Study Continuity"
Cohesion: 0.33
Nodes (5): Local data and recovery, Routes and history, Study Continuity, Verification, What learners can do

### Community 87 - "mesh-builder.mjs"
Cohesion: 0.80
Nodes (4): buildMeshes(), gridGeometry(), shellPoint(), tubeGeometry()

### Community 91 - "Main cleanup — 2026-09-10"
Cohesion: 0.40
Nodes (4): Complete branch inventory, Main cleanup — 2026-09-10, Recovered work, Verification and promotion

### Community 92 - "Anatomy research desk"
Cohesion: 0.08
Nodes (21): Acceptance evidence, Anatomy Lab — local review candidate, Coverage and upstream parity, Provenance and publication boundary, Run the complete candidate, Anatomy research desk, Content and navigation contract, Design (+13 more)

### Community 93 - "Q: How do PalDawn per-object anatomy provenance records enforce fail-closed adoption for this audit?"
Cohesion: 0.40
...
### Community 94 - "Q: what else can be implemented with high confidence"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: what else can be implemented with high confidence, Source Nodes

### Community 95 - "Q: Verify the refreshed PalDawn brand icon, app placements, PWA metadata, reduced-motion behavior, and release boundary."
Cohesion: 0.40
...
### Community 96 - "Q: What is the documented next phase after Deep Lens, and can it merge?"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: What is the documented next phase after Deep Lens, and can it merge?, Source Nodes

### Community 97 - "Q: Which next phase features can improve PalDawn with high implementation confidence?"
Cohesion: 0.40
...
### Community 101 - "Q: How is PalDawn Study Continuity wired across routes, local data, UI, and exports?"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: How is PalDawn Study Continuity wired across routes, local data, UI, and exports?, Source Nodes

## Knowledge Gaps
- **520 isolated node(s):** `VIEWS`, `totalTriangles`, `MaterialMode`, `root`, `source` (+515 more)
...
- `P0 to P3 Phase Roadmap` (2× useful, score=0.944343546) _(code changed — re-verify)_
- `Per-Object Anatomy Approval` (2× useful, score=0.935090061)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `exportLocalData()` connect `FlightDeck.tsx` to `MemoryStorage`, `localData.ts`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `encodeGLB()` connect `MemoryStorage` to `verify-heart.mjs`, `build-heart.mjs`, `mesh-builder.mjs`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `fitStudyCamera()` connect `verify-flow.mjs` to `verify-heart.mjs`?**
